...
use crate::coverage::analyzer::scan_directory;
use crate::coverage::matcher::compute_coverage;
use crate::coverage::report::{build_report, format_report, format_json_report, CoverageReport};
...
mod tests {
    use super::*;
    use crate::spec::contract::Semantic;
