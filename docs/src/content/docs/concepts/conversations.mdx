...
This is a key product differentiator. Commands like `lexicon contract new`, `lexicon score init`, and `lexicon gate init` do not just dump static files. Instead, they open an interactive, guided workflow that:
