...
This does not just dump a static file. Instead, it opens an interactive, guided workflow that:
...
4. Shows the draft for review
5. Opens an AI-assisted refinement conversation
6. Lets you iterate on the artifact conversationally
7. Preserves explicit boundaries between stable contract and speculative ideas
8. Validates the result and writes the final contract

The tool treats artifact creation as an evolving conversation, not a one-shot form.

Or list existing contracts:
