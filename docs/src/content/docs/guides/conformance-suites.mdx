...
You need an initialized lexicon repository with at least one contract. If you haven't created a contract yet, see the [Creating Your First Contract](/lexicon-rs/guides/first-contract/) guide.
