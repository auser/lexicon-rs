...
Use `lexicon score explain` for a detailed breakdown showing each dimension's weight, value, and contribution to the total score.
...
See the [CI Integration](/guides/ci-integration/) guide for a complete GitHub Actions example.
