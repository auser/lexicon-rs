...
- Learn about [Contracts](/lexicon-rs/concepts/contracts/) in depth
- Understand the [Scoring](/lexicon-rs/concepts/scoring/) model
- Set up [CI Integration](/lexicon-rs/guides/ci-integration/)
